...
const classesVariante: Record<ButtonVariant, string> = {
  primary:
...
const classesTamanho: Record<ButtonSize, string> = {
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  return (
    <button
      ...
      className={[
        "inline-flex items-center justify-center rounded-sm font-sans font-medium tracking-wide",
